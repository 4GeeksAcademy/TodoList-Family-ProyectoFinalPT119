      ...
      <div className="container page-container">
              ...
              <div className="modal-content modal-content-dark">
                <form onSubmit={handleCreateClan}>
                  <div className="modal-header">
                    <h5 className="modal-title">Crear Nuevo Clan</h5>
                  </div>
                  <div className="modal-body">
                    <div className="mb-3">
                      <label className="form-label">Nombre del Clan</label>
                      <input type="text" className="form-control" value={newClanName} onChange={(e) => setNewClanName(e.target.value)} required />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Categoría</label>
                      <input type="text" className="form-control" value={newClanCategory} onChange={(e) => setNewClanCategory(e.target.value)} placeholder="Ej: Familia, Amigos, Trabajo..." required />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Fecha de Creación</label>
                      <input type="date" className="form-control" value={newClanDate} onChange={(e) => setNewClanDate(e.target.value)} required />
                    </div>
                  </div>
        ...
        {showCodeModal && (
          <div className="modal" style={{ display: "block", backgroundColor: "rgba(0,0,0,0.5)" }}>
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content modal-content-dark">
                <div className="modal-header">
                  <h5 className="modal-title">¡Clan Creado!</h5>
                </div>
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content modal-content-dark">
                <form onSubmit={handleJoinClan}>
                  <div className="modal-header">
                    <h5 className="modal-title">Unirse a un Clan</h5>
                  </div>
                  <div className="modal-body">
                    <div className="mb-3">
                      <label className="form-label">Código de Invitación</label>
                      <input type="text" className="form-control" value={joinCode} onChange={(e) => setJoinCode(e.target.value)} required />
                    </div>
                  </div>
                  <div className="modal-footer">
        ...
        <div className="main-box">
          ...
          <div className="mt-4 d-flex justify-content-between responsive-button-group">
            <button className="btn btn-custom-blue btn-lg" onClick={() => setShowCreateModal(true)}>Crear Nuevo Clan</button>
            <button className="btn btn-custom-purple btn-lg" onClick={() => setShowJoinModal(true)}>Unirse a un Clan</button>
            <button className="btn btn-outline-danger btn-lg" onClick={handleDeleteClan} disabled={!store.activeClanId}>Eliminar Clan</button>
          </div>
        </div>
      </div>
    </div>
